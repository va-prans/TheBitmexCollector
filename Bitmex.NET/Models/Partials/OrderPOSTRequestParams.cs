...
namespace Bitmex.NET.Models
{
    public partial class OrderPOSTRequestParams
    {
        ...
        public static OrderPOSTRequestParams CreateSimpleLimitReduceOnly(string symbol, decimal quantity, decimal price, OrderSide side)
        {
            return new OrderPOSTRequestParams
            {
                Symbol = symbol,
                ...
                DisplayQty = quantity,
                Price = price,
                ExecInst = "ParticipateDoNotInitiate,Close,LastPrice",
            };
        }
        ...
        public static OrderPOSTRequestParams CreateMarketTakeProfitOrder(string symbol, decimal quantity, decimal stopPrice, OrderSide side)
        {
            return new OrderPOSTRequestParams
            {
                Symbol = symbol,
